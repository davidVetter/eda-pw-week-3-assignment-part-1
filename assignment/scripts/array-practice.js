...
let favFood = ['pizza', 'pasta', 'noodles', 'steak', 'stir fry'];
...
console.log('The last animal by length is ', (animalArray[animalArray.length - 1]));
...
favFood.unshift('burger');
console.log(`Added a food to the beginning: ${favFood.join(', ')}`);
